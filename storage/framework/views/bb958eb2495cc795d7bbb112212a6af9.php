...
<div class="grid grid-cols-1 xl:grid-cols-3 gap-8">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5 mb-8">
            ...
            <form method="GET"
                ...
                <select
                    ...
                    <option value="kopi"
                        <?php echo e(request('category') == 'kopi' ? 'selected' : ''); ?>>
                        Coffee
                    </option>

                    <option value="non_kopi"
                        <?php echo e(request('category') == 'non_kopi' ? 'selected' : ''); ?>>
                        Non Coffee
                    </option>

                    <option value="snack"
                        <?php echo e(request('category') == 'snack' ? 'selected' : ''); ?>>
                        Snack
                    </option>
        ...
        <div class="grid grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-6">
            ...
            <div class="product-card bg-white rounded-[32px] overflow-visible border border-[#eee] shadow-sm hover:shadow-xl transition duration-300">
                ...
                <div class="px-4 relative -mt-16 z-20">
                    <button type="button" onclick="addToCart('<?php echo e($product->id); ?>', '<?php echo e($product->name); ?>', '<?php echo e($product->selling_price); ?>', '<?php echo e(asset('storage/' . $product->image)); ?>')"
                ...
                <div class="mt-5">
                    ...
                    <h4 class="text-xl font-bold text-[#6b3e2e] mt-1">Rp <?php echo e(number_format($product->selling_price,0,',','.')); ?></h4>
                </div>
            </div>
        </div>
    ...
    <div>
        ...
        <form action="/orders"
              method="POST"
              id="orderForm"
              class="bg-white rounded-3xl p-7 shadow-sm border border-[#eee] sticky top-5">
            ...
            <div class="flex items-center justify-between mb-7">
                ...
                <div class="w-14 h-14 rounded-2xl bg-[#f5ebe4]
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\xampp\htdocs\perjalanan-kopi\resources\views/orders/create.blade.php ENDPATH**/ ?>