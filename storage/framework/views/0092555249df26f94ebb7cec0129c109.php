                ...
                <div class="flex items-start gap-5">
                    ...
                    <div>
                        ...
                        <h3 class="text-2xl font-bold text-[#2d140d]">
                            ...
                            <?php echo e(\Carbon\Carbon::parse($order->order_time)->format('d-m-Y H:i:s')); ?>
                            ...
                            <tr class="border-b border-[#f2f2f2]">
                                ...
                                <td class="px-6 py-6">
                                    ...
                                    <div class="flex items-center gap-4">
                                        ...
                                        <img
                                            src="<?php echo e(asset('storage/' . ($item->product->image ?? 'default.png'))); ?>"
                                ...
                                <td class="px-6 py-6">
                                    Rp <?php echo e(number_format($item->hpp, 0, ',', '.')); ?>
                                ...
                                <td class="px-6 py-6 text-green-600 font-semibold">
                                    ...
                                    Rp <?php echo e(number_format(($item->selling_price - $item->hpp) * $item->quantity, 0, ',', '.')); ?>
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <h3 class="text-2xl font-semibold">
                            Rp <?php echo e(number_format($order->discount_amount ?? 0, 0, ',', '.')); ?>
                    ...
                    <?php if($order->payment): ?>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <h3 class="text-3xl font-bold text-[#2d140d]">
                                ...
                                Rp <?php echo e(number_format($order->payment->amount_paid, 0, ',', '.')); ?>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <h3 class="text-3xl font-bold text-green-600">
                                ...
                                Rp <?php echo e(number_format($order->payment->change_amount, 0, ',', '.')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\xampp\htdocs\perjalanan-kopi\resources\views/orders/detail.blade.php ENDPATH**/ ?>