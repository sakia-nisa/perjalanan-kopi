                        ...
                        <td class="px-6 py-5">
                            ...
                            <div class="flex flex-wrap items-center gap-2">
                                ...
                                <?php if($order->status != 'completed'): ?>
                                    ...
                                    <!-- EDIT -->
                                    <a href="/orders/<?php echo e($order->id); ?>/edit"
                                    ...
                                    <!-- PAYMENT -->
                                    <a href="/orders/<?php echo e($order->id); ?>/payment"
...
<div class="mt-10 flex flex-col items-center gap-4">
    ...
    <p class="text-gray-500">
        ...
        Showing <?php echo e($orders->firstItem()); ?>

        to <?php echo e($orders->lastItem()); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\xampp\htdocs\perjalanan-kopi\resources\views/orders/index.blade.php ENDPATH**/ ?>