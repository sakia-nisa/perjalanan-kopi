            ...
            <form action="/login" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="username" value="<?php echo e(old('username')); ?>" placeholder="Masukkan ID Anda" required autofocus class="w-full h-[54px] rounded-xl bg-[#ece8e5] border border-[#d8d0cc] pl-12 pr-4 outline-none focus:ring-4 focus:ring-[#4b1e16]/20 focus:border-[#4b1e16] transition">
                    </div>
                </div>
                <!-- PASSWORD -->
                <div>
...
</html><?php /**PATH E:\xampp\htdocs\perjalanan-kopi\resources\views/auth/login.blade.php ENDPATH**/ ?>